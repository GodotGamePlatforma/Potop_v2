...
@export var deep_darkness_min_depth: float = 105.0
@export var shallow_ambient_color: Color = Color(0.96, 0.98, 1.0, 1.0)
@export var deep_ambient_color: Color = Color(0.32, 0.38, 0.48, 1.0)
