...
const WorkshopRecipeDefinitionScript := preload("res://scripts/definitions/WorkshopRecipeDefinition.gd")
...
func get_recipe(recipe_id: String):
	if recipe_id.is_empty():
		return null
	var path := "res://data/workshop_recipes/%s.tres" % recipe_id
...
func _workshop_capabilities(workshop_level: int) -> Dictionary:
	var definition = ResourceLoader.load("res://data/buildings/workshop.tres")
