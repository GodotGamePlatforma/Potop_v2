...
const BUILDING_ART_DIRECTORY := "res://assets/base/building_blueprints"

const BaseEnvironmentScript := preload("res://scripts/base/BaseEnvironment.gd")
const DaySummaryPanelScript := preload("res://scripts/base/DaySummaryPanel.gd")
const DayReportJournalPanelScript := preload("res://scripts/base/DayReportJournalPanel.gd")
const MissionJournalPanelScript := preload("res://scripts/base/MissionJournalPanel.gd")
...
const DifficultyDebugPanelScript := preload("res://scripts/base/DifficultyDebugPanel.gd")
const BuildingSlotScene := preload("res://scenes/base/BuildingSlot.tscn")
const BuildingPanelScene := preload("res://scenes/base/BuildingPanel.tscn")
const WorkerCandidatePickerPanelScript := preload("res://scripts/base/WorkerCandidatePickerPanel.gd")
const BuildingPresentationScript := preload("res://scripts/base/BuildingPresentation.gd")
const BuildingOccupancyBadgeScript := preload("res://scripts/base/BuildingOccupancyBadge.gd")
