...
- Recenzent, supervisor i integrator odbierają rewizję FROZEN albo receipt asynchronicznie. Po wystawieniu dowodu autor natychmiast wykonuje zwykły commit/push przekazanej rewizji i może rozpocząć N+1; nie wolno zatrzymywać go przed tym commitem ani blokować N+1 oczekiwaniem na recenzję. Wynik `FAIL` tworzy osobny follow-up z nowym SHA, a brak immutable hand-offu blokuje wyłącznie jego konsumenta. Do obserwacji używaj zdarzenia albo jednego ograniczonego czasowo oczekiwania zamiast krótkiego pollingu.
