...
- 2026-08-28, Godot 4.7.1: izolowany `DiverPresentationTest.tscn` przeszedł `1/1`. Test mierzy 48/48 klatek, waliduje kopertę `105 × 60`, aktywne profile avatara i scenę, czasy pętli, fazę przejść, osiem kierunków, oba odbicia, cue oraz rzeczywisty `move_and_slide()`.
- 2026-08-28, Godot 4.7.1: rootowy `diver_clearance_integration_test.gd` przeszedł headless i native. Rzeczywisty widok dał 58,94 jednostki przewagi przy pływaniu, 91,27 przy sprincie i 0,02 po wyhamowaniu; prąd nie utworzył dodatkowego celu wyprzedzenia, oba skrajne limity mapy pozostały szczelne, a trzy kadry 1280×720 przeszły oględziny. To potwierdza integrację sceny avatara z bieżącą Mapą, ale nie zastępuje subiektywnego playtestu strojenia.
- Ostatni natywny odbiór `DiverPresentationCapture.tscn` z 2026-08-27 przeszedł `1/1`. Obejrzano macierz koperty, kluczowe klatki `idle/swim/sprint`, oba kierunki, sockety, oba kadry kontaktu oraz Latarnie off/I/II. Alfa mieściła się w zatwierdzonej kopercie, kontakt odpowiadał colliderowi, a jedyne światło pozostawało radialne i centralne na originie. Ten syntetyczny capture nie był ponawiany dla bieżącej zmiany kamery i nie zastępuje mapowego playtestu.
