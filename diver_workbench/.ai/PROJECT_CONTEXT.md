...
- `[PENDING_ROOT_MAP_INTEGRATION]` Collider `105 × 60` zmienia publiczną kopertę fizyczną. Zakres integracyjny Root/Mapa musi dostroić certyfikację prześwitów i nawigacji oraz wykonać rzeczywiste przepłynięcie ciasnych przejść; lokalny harness nie certyfikuje topologii świata ani odczucia sterowania.
