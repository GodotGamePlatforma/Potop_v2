...
const BUILDING_DEFINITIONS := {
	"fishing_hut": preload("res://data/buildings/fishing_hut.tres"),
	"kitchen": preload("res://data/buildings/kitchen.tres"),
	"community_house": preload("res://data/buildings/community_house.tres"),
	"workshop": preload("res://data/buildings/workshop.tres"),
	"infirmary": preload("res://data/buildings/infirmary.tres"),
	"diving_station": preload("res://data/buildings/diving_station.tres"),
}
...
func _test_shared_panel_renders_descriptions_for_every_building() -> void:
	var building_panel_script = load("res://scripts/base/BuildingPanel.gd")
