...
const REQUIRED_AGENT_CONCURRENCY_FRAGMENTS := {
	"res://AGENTS.md": [
		...
		"nie wymaga candidate/run receiptów ani lokalnego LKG",
		"assignmentu `RUNNING`",
...
const REQUIRED_CONCURRENCY_GUARD_FRAGMENTS := {
	...
	"res://tools/setup_agent_worktree.ps1": [
		...
		"create-main",
		"ASSIGNMENT CREATED: WAITING_ACK",
		"cannot be combined with candidate/run receipts",
		"codex/$safeOwner/$TaskSlug",
		"Remove-WorktreeAttempt",
	],
	"res://tests/setup_agent_worktree_test.ps1": [
		"-FromOriginMain",
		"schema-v2 WAITING_ACK bundle",
		"assignment ack",
		"AfterGitWorktreeAdd",
	...
	"res://.github/workflows/agent-auto-integrator.yml": [
		"repository_dispatch:",
		"verify-fast-pr",
		"openai/codex-action@",
		"Publish App-owned fast-green",
