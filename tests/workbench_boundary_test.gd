...
const REQUIRED_AGENT_DELIVERY_FRAGMENTS := {
	"res://AGENTS.md": [
		...
		"commit -> tools/publish_agent_pr.ps1 (push + PR) -> KONIEC",
		"Brak commitu albo opublikowanego PR oznacza zadanie niedostarczone",
	...
	"res://README.md": [
		...
		"Brak logicznego commitu albo PR opublikowanego przez helper oznacza zadanie niedostarczone",
	...
	"res://base_workbench/AGENTS.md": [
		...
		"implementacja -> lokalne testy zadania -> lokalny fast-check -> commit -> tools/publish_agent_pr.ps1 (push + PR) -> KONIEC",
		"Brak commitu albo opublikowanego PR oznacza zadanie niedostarczone",
	...
	"res://base_workbench/README.md": [
		...
		"Brak commitu lub PR nie jest dostarczeniem zadania",
	],
	"res://underwater_map_workbench/AGENTS.md": [
