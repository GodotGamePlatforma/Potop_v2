...
const BaseWorld3DScript := preload("res://base_workbench/runtime/BaseWorld3D.gd")

const PLATFORM_MODEL_PATH := "res://base_workbench/assets/platform_3d/start_platform_ruins.glb"
const FAR_RAIN_SHADER_PATH := "res://base_workbench/assets/environment_3d/rain_far_veil.gdshader"
const BUILDING_HIGHLIGHT_BLUR_SHADER_PATH := "res://base_workbench/assets/environment_3d/building_highlight_blur_horizontal.gdshader"
const BUILDING_HIGHLIGHT_SHADER_PATH := "res://base_workbench/assets/environment_3d/building_highlight_outline.gdshader"
