...
func _run() -> void:
	var platform_import_path := "res://base_workbench/assets/platform_3d/start_platform_ruins.glb.import"
	...
	for file_name in DirAccess.get_files_at("res://base_workbench/assets/platform_3d"):
	...
	var base_world_source := FileAccess.get_file_as_string("res://base_workbench/runtime/BaseWorld3D.gd")
