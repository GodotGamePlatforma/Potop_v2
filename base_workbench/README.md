...
Zwykły autor nie uruchamia pełnej regresji. Po `PASS` wykonuje commit, następnie `tools/publish_agent_pr.ps1`, który publikuje branch i PR, po czym kończy pracę bez pollingu kolejki. Brak commitu lub PR nie jest dostarczeniem zadania.
