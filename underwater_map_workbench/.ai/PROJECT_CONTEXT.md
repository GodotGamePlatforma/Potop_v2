...
- W01 jest przypięty do sealed manifestu `f3791ecc…f3a13`. Produkcyjna L04 została zbudowana od pustego natywnego rastra `2240 × 3680` jako wyłącznie open-water, bez użycia poprzedniego RGB i bez resize'u lub resamplingu; alfa nadal odpowiada kanonicznej masce piksel w piksel. L05 używa przebudowanej bitmapy konstrukcji w spójnym miejskim stylu. Mapowa `presentation_revision` wynosi `l01-airy-ruin-field-production-v24`; L01 składa się z 209 bindingów korzystających z 21 natywnych PNG jako `nonblocking_backdrop`, a lokalny digest topologii struktury, globalna topologia, partycja ownerów i sygnatura gameplayu pozostają bez zmian.
