...
- W01 jest przypięty do sealed manifestu `f3791ecc…f3a13`. Produkcyjna L04 została zbudowana od pustego natywnego rastra `2240 × 3680` jako wyłącznie open-water, bez użycia poprzedniego RGB i bez resize'u lub resamplingu; alfa nadal odpowiada kanonicznej masce piksel w piksel. L05 używa przebudowanej bitmapy konstrukcji w spójnym miejskim stylu. Mapowa `presentation_revision` wynosi `center-station-right-city-two-tower-production-v20`, a lokalny digest topologii struktury, globalna topologia, partycja ownerów i sygnatura gameplayu pozostają bez zmian.
