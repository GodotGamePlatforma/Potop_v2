...
- D2. Clearance jest world-locked prezentacją hostowaną pod L04, ale używa jawnego globalnego z-orderu większego niż oba nieblokujące plany L01/L02 i mniejszego niż L03 oraz L04. Wypełnia rdzeń kolorem `visual.water_color`, a na ograniczonym rasterowym marginesie przechodzi do przezroczystości. Wielkość rdzenia, padding wzdłuż otworu i feather są dodatnimi, wersjonowanymi stałymi kontraktu buildera; nie wynikają z ID ani ręcznego strojenia pojedynczego pakietu.
